...
- [Arduino Game Boy Printer Emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) - An arduino nano emulating a Game Boy printer via the Game Boy Link cable. Non invasive to the Game Boy.
...
- [gbcpu](https://github.com/jdeblese/gbcpu) - A CPU and peripherals implementing the Gameboy (TM) instruction set and functionality.
